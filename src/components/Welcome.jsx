    ...
    <div className="flex flex-col w-full justify-center items-center pb-12">
      <div className="flex mf:flex-row flex-col items-start justify-between">
        <div className="p-5 w-full flex flex-col justify-start items-start blue-glassmorphism z-40">
          <div>
            <div>
              <p className="py-3 px-2 font-3xl font-bold text-[#968FA8] font-serif">
                From
              </p>
            </div>
            <div class="grid grid-cols-3 gap-4 my-7">
              <div className="group inline-block relative">
                <button className="font-medium text-gray-600 hover:text-[#F2175D] px-5 py-3 flex items-center transition duration-150 ease-in-out">
                ...
                <div className="grid grid-cols-1 bg-white shadow-2xl rounded-md absolute hidden pt-3 group-hover:block group-hover:absolute group font-medium text-gray-600 hover:text-gray-900 flex items-center transition duration-150 ease-in-out z-40">
                  <div className="group-hover: w-96 ">
                    <a
                      href="#"
                      className="rounded-t py-1 px-2 block whitespace-no-wrap font-medium text-gray-600 hover:text-[#F2175D] px-5 py-3 flex items-center transition hover:bg-[#f5f5f5] duration-150 ease-in-out "
                      passHref
                    >
                  ...
                  <div className="group-hover: w-96">
                    <a
                      href="/pulse"
                      type="button"
                      className="overflow-hidden rounded-t py-1 px-2 block whitespace font-medium text-gray-600 hover:text-[#F2175D] hover:bg-[#f5f5f5] px-5 py-3 flex items-center transition duration-150 ease-in-out cursor-pointer"
                      passHref
                    >
                      <div className="flex flex-row px-3 cursor-pointer">
                  ...
                  <div className="group-hover: w-96 ">
                    <a
                      href="#"
                      type="button"
                      className="rounded-t overflow-hidden py-1 px-2 block whitespace font-medium text-gray-600 hover:text-[#F2175D] flex items-center transition hover:bg-[#f5f5f5] duration-150 ease-in-out cursor-pointer"
                      passHref
                    >
                      <div className="flex flex-row px-3 cursor-pointer">
                        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded bg-[#EFF6FF]">
                          ...
                          >
                            ...
                            />
                            <path
                              d="M218.491 327.173C230.306 327.173 241.213 323.236 249.999 316.422L177.893 244.342C171.076 252.973 167.138 263.876 167.138 275.839C166.986 304.156 190.012 327.173 218.491 327.173Z"
                              fill="#EFEFEF"
                            />
                            <path
                              d="M432.99 275.687C432.99 263.876 429.052 252.973 422.235 244.19L350.129 316.27C358.763 323.084 369.67 327.021 381.637 327.021C409.965 327.173 432.99 304.156 432.99 275.687Z"
                              fill="#EFEFEF"
                            />
                            <path
                              d="M469.346 197.4L437.383 229.351C447.987 242.071 454.349 258.123 454.349 275.991C454.349 316.119 421.78 348.676 381.637 348.676C363.914 348.676 347.705 342.316 334.98 331.716L299.988 366.696L264.995 331.716C252.271 342.316 236.213 348.676 218.338 348.676C178.195 348.676 145.627 316.119 145.627 275.991C145.627 258.274 151.989 242.071 162.593 229.351L146.232 212.997L130.63 197.4C112.452 227.383 102 262.363 102 299.917C102 409.247 190.617 497.681 299.836 497.681C409.056 497.681 497.673 409.096 497.673 299.917C497.976 262.211 487.524 227.231 469.346 197.4Z"
                              fill="#EFEFEF"
                            />
                            <path
                              d="M443.139 163.328C407.238 125.623 356.339 102 299.988 102C243.636 102 192.889 125.623 156.836 163.328C151.989 168.477 147.293 173.928 142.9 179.531L299.836 336.41L456.773 179.38C452.834 173.928 448.138 168.325 443.139 163.328ZM299.988 127.743C346.342 127.743 389.363 145.611 421.629 178.168L299.988 299.764L178.347 178.168C210.764 145.611 253.634 127.743 299.988 127.743Z"
                              fill="#EFEFEF"
                            />
                          </svg>
                        </div>
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between z-10 py-7">
        <div className="p-5 w-full flex flex-col justify-start items-start blue-glassmorphism">
          <div>
            <div>
              <p className="py-1 pt-3 px-1 font-3xl font-bold text-[#968FA8] font-serif">
                Enter Address
              </p>
            </div>
      ...
      <div className="flex flex-row py-7 px-3">
        <button className="mx-8 px-5 py-3 flex items-center text-xl text-white blue-glassmorphism" >
          Approve
        </button>
        <button className="mx-8 px-7 py-3 flex items-center text-xl text-white blue-glassmorphism">
          Send
        </button>
      </div>
    </div>
